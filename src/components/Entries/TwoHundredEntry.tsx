...
const TwoHundredEntry = () => {
  return(
    <Entry title="200! (2022) [After Effects, Mocha, Premiere]" subtitle={<h2>for <a href="https://open.spotify.com/artist/2KX08AwhdUadg1S4yurmce" target="blank">@aloevittoria</a></h2>}>
